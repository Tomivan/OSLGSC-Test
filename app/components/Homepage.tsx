          ...
          <div className="w-full relative lg:max-w-[1280px] mx-auto">
            <div className="w-full mt-[100px] md:mt-[166px]">
              <div className="text-center">
                {/* Exo font applied only to these headings */}
                <h1 className={`${exoFont.className} text-[#3b8501] font-extrabold uppercase text-[32px] md:text-[67.45px] md:mb-[22.5px] tracking-0 md:leading-[82px] leading-[46px]`}>
                  2026 Local
                </h1>
                <h2 className={`${exoFont.className} font-extrabold text-[#3b8501] uppercase text-[32px] md:text-[67.45px] md:mb-[22.5px] tracking-0 md:leading-[82px] leading-[46px]`}>
                  Government Service
                </h2>
                <h2 className={`${exoFont.className} font-extrabold text-[#3b8501] uppercase text-[32px] md:text-[67.45px] md:mb-[22.5px] tracking-0 md:leading-[82px] leading-[46px]`}>
                  Week Award
