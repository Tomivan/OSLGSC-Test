	...
	return (
		<main className="bg-[white] flex md:pb-[65px] pb-[40px] justify-center text-white">
			<section className="md:w-full w-[90%] md:max-w-[1280px] flex justify-center items-center">
				<div className="md:pt-[95px] pt-[40px] w-full">
					...
					<div className="flex flex-wrap gap-[15px] mt-[24px] justify-center">
						<div className="bg-[#3B8501] p-[26px] rounded-[10px] flex-1 min-w-[200px] max-w-[280px]">
							...
							<p className="text-[11px] md:text-[14px] tracking-0 leading-[20px] md:leading-[24px] text-[#FAFAFA]">
