...
const Navbar = () => {
	return (
		<div className="max-w-md md:max-w-[1280px] flex justify-between md:mx-auto bg-white overflow-hidden">
			<section className="p-4 w-full md:w-[80%] flex justify-between mx-auto my-auto items-center">
				<div className="flex">
				<Image
					src={logo}
					alt="OSLGSC Logo"
				...
				/>
				<h1 className="font-bold w-[200px] md:w-[283px] text-[11px] md:leading-[18px] md:text-base uppercase md:ml-[5px] text-[#343434] my-auto">
