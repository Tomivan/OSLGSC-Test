...
const DetailsConfirmationModal = () => {
	return (
			...
			<div className="bg-[#CFCDCD] rounded-lg p-8 max-w-sm w-full relative">
				...
				<div className="text-center pt-4">
					<h2 className="text-black text-lg font-medium mb-8 mt-[10px] leading-relaxed">
						Kindly fill the required details in this section to
						proceed
					</h2>

					<div className="flex justify-center">
						<button className="bg-[#3B8501] uppercase hover:bg-[#2d6801] text-white font-bold py-3 px-8 rounded transition-colors duration-200 min-w-[80px]">
							Take me back
						</button>
					</div>
				</div>
